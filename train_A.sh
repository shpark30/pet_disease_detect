...
ROOT='../../../input/data/피부염'
# ROOT='../../../input/data/구진플라크/구진플라크_유증상/A1_구진_플라크' # data path
MODEL_PATH='../../../output/train/model/피부염/220222' # path where a model will be saved
LOG_PATH='../../../output/train/log/피부염/220222'
LOG_NAME='train.log'
LOG_FREQ=5
WORKERS=4
EPOCHS=100
